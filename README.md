...
This is an image classification app built using **Django**, **Next.js**, and **Material UI**. The app uses **Inception-ResNet-v2** to classify images selected by the user.
